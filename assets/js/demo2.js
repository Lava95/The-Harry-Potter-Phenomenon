...
demo = {
    ...
    initChartist: function(){
        ...
        for(i=0;i<len;i++) {
            ...
            //if(cat2.split(',')[i].split(':')[0] == 'Sports'_)
                category_list.push(cat2.split(',')[i]);//.split(':')[0]);
            category_value.push(cat2.split(',')[i].split(':')[1])
            //.split(":")[0].split("{")[1];
    ...
    initChartist_emotion: function(){
        ...
        for(i=0;i<len;i++) {
            ...
            emotion_list.push(cat2.split(',')[i]);//.split(':')[0]);
            emotion_value.push(cat2.split(',')[i].split(':')[1])
            //.split(":")[0].split("{")[1];
        }
